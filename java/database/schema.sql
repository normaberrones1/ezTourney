...
CREATE TABLE tourney_directors (
    tourney_id int NOT NULL,
    director_id int NOT NULL,
    CONSTRAINT PK_tourney_directors PRIMARY KEY (tourney_id, director_id),
...
CREATE TABLE tourney_matches (
    ...
    round int NOT NULL,
    seat int,
    CONSTRAINT PK_tourney_matches PRIMARY KEY (tourney_id, team_1_id, team_2_id, round),
